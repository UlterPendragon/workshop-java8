...
public class Function_04_Test {
	...
	// TODO AGE >=18
	Predicate<Person> adult = p1 -> p1.getAge() >= 18;
	// end::adult[]
	...
	public void test_predicate() throws Exception {
		...
		Person billyj = new Person("Billy", "Jones", 21, "sangohan");
		Person robertr = new Person("Robert", "Redford", 68, "krilin");
		Person felicityj = new Person("Felicity", "Jones", 68, "sangoku");
		Person scarlettj = new Person("Scarlett", "Johansson",19, "freezer");
