...
public class Lambda_01_Test {
	...
	private List<Person> filter(List<Person> persons, PersonPredicate predicate) {
		...
		// DONE implementer la méthode (liste de personne et un prédicat)
		// creer une liste
	...
	/*	Avant java 8 
	    ...
	    PersonPredicate a = new PersonPredicate(){
		...
		// DONE result ne doit contenir que des personnes adultes (age >= 18)
